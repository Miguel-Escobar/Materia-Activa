...
dataexpanded = np.load("No termalizado si expandido\\Hertzian\\analyzed_data.npz")
datacontracted = np.load("No termalizado si contraido\\Hertzian\\analyzed_data.npz")
fig = plt.figure()
fig.clf()
